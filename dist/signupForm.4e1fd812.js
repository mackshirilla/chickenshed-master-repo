...
})({"6L869":[function(require,module,exports) {
...
const signupForm = ()=>{
    ...
    const fields = [
        ...
        },
        {
            ...
            validationFn: (0, _validationUtils.validatePasswordRequirements),
            message: "Password must meet the requirements below."
        },
        {
            input: new (0, _core.WFComponent)("#termsInput"),
            error: new (0, _core.WFComponent)("#termsInputError"),
...
},{"@xatom/core":"j9zXV","../../../utils/formUtils":"hvg7i","../../../utils/validationUtils":"dMBjH","../../../utils/recaptchaUtils":"d0IfT","../../../api/apiConfig":"2Lx0S","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"hvg7i":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
//# sourceMappingURL=signupForm.4e1fd812.js.map
