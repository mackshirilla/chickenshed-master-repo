...
})({"3jmi9":[function(require,module,exports) {
...
var _sidebar = require("../sidebar"); // Adjust the import path as necessary
const addStudentProfile = async ()=>{
    ...
    const attachBackButtonListeners = ()=>{
        ...
        backStepTen.on("click", (event)=>{
            ...
            (0, _sidebar.unmarkStepAsCompleted)(9);
            (0, _sidebar.unsetActiveStep)(10);
        });
    };
    ...
    formStepOne.onFormSubmit(async (formData, event)=>{
        ...
        if (existingStudentCheck) {
            ...
            (0, _sidebar.markStepAsCompleted)(1); // Mark Step 1 as completed
            slider.goNext();
            stepOneRequestingAnimation.setStyle({
                display: "none"
            }); // Hide loading animation
        ...
        try {
            ...
            if (response.status === "success") {
                ...
                (0, _sidebar.markStepAsCompleted)(1);
    ...
    formStepTwo.onFormSubmit(async (formData, event)=>{
        ...
        (0, _sidebar.markStepAsCompleted)(2);
        // Navigate to the next step
        slider.goNext();
    });
    // Step 3
    ...
    formStepThree.onFormSubmit(async (formData, event)=>{
        ...
        (0, _sidebar.markStepAsCompleted)(3);
        // Navigate to the next step
        slider.goNext();
    });
    ...
    caregiverForm.onFormSubmit(async (formData, event)=>{
        ...
        try {
            ...
            if (response.status === "success") {
                ...
                (0, _sidebar.markStepAsCompleted)(4);
            }
        } catch (error) {
    ...
    formStepFive.onFormSubmit(async (formData, event)=>{
        ...
        (0, _sidebar.markStepAsCompleted)(5);
        // Navigate to the next step
        slider.goNext();
    });
    // Step 6
    ...
    formStepSix.onFormSubmit(async (formData, event)=>{
        ...
        (0, _sidebar.markStepAsCompleted)(6);
        // Navigate to the next step
        slider.goNext();
    });
    // Step 7
    ...
    formStepSeven.onFormSubmit(async (formData, event)=>{
        ...
        (0, _sidebar.markStepAsCompleted)(7);
        // Navigate to the next step
        slider.goNext();
    });
    ...
    submitStepEight.on("click", async (event)=>{
        ...
        try {
            ...
            if (response.status === "success") {
                ...
                (0, _sidebar.markStepAsCompleted)(8);
                // Go to next step
                slider.goNext();
            } else {
...
},{"@xatom/core":"j9zXV","@xatom/image":"ly8Ay","@xatom/slider":"2zMuG","../../../../../utils/formUtils":"hvg7i","../../../../../utils/validationUtils":"dMBjH","../../../../../utils/recaptchaUtils":"d0IfT","../../../../../api/apiConfig":"2Lx0S","../sidebar":"5kv9Q","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"ly8Ay":[function(require,module,exports) {
...
},{"../api/apiConfig":"2Lx0S","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"5kv9Q":[function(require,module,exports) {
...
//# sourceMappingURL=addStudentProfile.14263d91.js.map
