...
const app = ()=>{
    ...
    new (0, _core.WFRoute)("/dashboard").execute(async ()=>{
        try {
            const isValidUser = await (0, _authServices.validateUser)();
            if (isValidUser) require("c9200bc08376cf63").then(({ dashboard })=>dashboard());
            else (0, _core.navigate)("/login");
        } catch (error) {
            console.error("Error validating user:", error);
        }
    ...
    new (0, _core.WFRoute)("/dashboard/ticket-order/ticket-order").execute(async ()=>{
        try {
            const isValidUser = await (0, _authServices.validateUser)();
    ...
    //program details
    new (0, _core.WFRoute)("/dashboard/registration/subscription").execute(async ()=>{
        try {
            const isValidUser = await (0, _authServices.validateUser)();
    ...
    //workshop details
    new (0, _core.WFRoute)("/dashboard/registration/subscription/workshop").execute(async ()=>{
        try {
            const isValidUser = await (0, _authServices.validateUser)();
    ...
    //session details
    new (0, _core.WFRoute)("/dashboard/registration/subscription/session").execute(async ()=>{
        try {
            const isValidUser = await (0, _authServices.validateUser)();
    ...
    new (0, _core.WFRoute)("/program-registration").execute(async ()=>{
        try {
            const isValidUser = await (0, _authServices.validateUser)();
            if (isValidUser) require("8d4dacf466b27681").then(({ programRegistration })=>programRegistration());
            else (0, _core.navigate)("/login");
        } catch (error) {
            console.error("Error validating user:", error);
        }
...
// Success Page
new (0, _core.WFRoute)("/success").execute(()=>{
    require("4af58126ccd0ec37").then(({ initializeSuccessPage })=>initializeSuccessPage());
});

},{"@xatom/core":"j9zXV","../auth/authServices":"6eR0A","9a2335a27cbf65a3":"bTOce","7194166fd8337774":"fhq5Z","e2ab45e640045078":"jVnxb","e8cdc03cffab5ce1":"ihXVo","75247311a1c12717":"67ypL","6668530cc5fc2a48":"828Hh","c963ab9512585f1e":"aRAsf","19e90e38cb67fd3b":"flPQg","a246b5f935105baf":"bsYvG","c9200bc08376cf63":"eAkhM","2619017f25f3bc5b":"gTleJ","99743dba8367c446":"gEJmS","c0af3facc5236bf2":"lKs9L","5ce3a1e7e087ca21":"28jLL","a34e417cd1356cda":"PI9rK","54b7e49ce1bac6b":"joeNl","3c4b9c1bf9fd381c":"7N7c8","10b04f5428dd1b86":"eLvwz","8d4dacf466b27681":"jtT5I","569383165c482279":"drA5e","f148efd480f281f5":"b9mA5","a30a014fa3a8661a":"8gDqx","4af58126ccd0ec37":"jqzU8","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"6eR0A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"6345bcd6585ffd41":"3dDkg","f903a110efc587f3":"jkqJ4"}],"jtT5I":[function(require,module,exports) {
module.exports = require("a628f007fb92d876")(require("c4005519c261a63d").getBundleURL("1Q55w") + "programRegistration.8f6100d7.js").catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("8DzTT"));

},{"a628f007fb92d876":"3dDkg","c4005519c261a63d":"jkqJ4"}],"drA5e":[function(require,module,exports) {
...
},{"6612934174bc1ab1":"3dDkg","538583f2cb5752b5":"jkqJ4"}],"jqzU8":[function(require,module,exports) {
module.exports = require("2f2dcc5ab8207329")(require("26f6552fffab3ade").getBundleURL("1Q55w") + "success_page.9d507600.js").catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("dfuG7"));

},{"2f2dcc5ab8207329":"3dDkg","26f6552fffab3ade":"jkqJ4"}]},["jeTtx"], "jeTtx", "parcelRequired346")
