...
})({"5JjZb":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "newProgramRegistration", ()=>newProgramRegistration);
var _startLabRegistration = require("../../api/startLabRegistration");
...
var _deleteOrderURLParam = require("./components/deleteOrderURLParam");
async function newProgramRegistration() {
    console.log("new registration");
    // 🧹 If URL has ?session_id=cs_..., cancel it in Xano and strip the param.
    await (0, _deleteOrderURLParam.initializeDeleteOrderFromUrl)();
    try {
        const response = await (0, _startLabRegistration.startRegistration)({});
...
function populateWorkshopOptions(row, data, selectedProgramId, config) {
    ...
    if (filteredSessions.length > 0) {
        ...
        const sortedWorkshops = Array.from(workshopsMap.entries()).sort((a, b)=>a[1].localeCompare(b[1]));
...
function attachRowEventListeners(row, data, config) {
    ...
    studentSelect.on("change", ()=>{
        const programEl = row.getChildAsComponent(config.fields.program.selectSelector).getElement();
        const workshopEl = row.getChildAsComponent(config.fields.workshop.selectSelector).getElement();
        const sessionEl = row.getChildAsComponent(config.fields.session.selectSelector).getElement();
        const studentEl = row.getChildAsComponent(config.fields.student.selectSelector).getElement();
        ...
        const tableBodyEl = document.querySelector(config.tableBodySelector);
        if (tableBodyEl) {
            const duplicate = Array.from(tableBodyEl.querySelectorAll("tr.confirmed")).some((tr)=>tr.getAttribute("data-session-id") === sessionId && tr.getAttribute("data-student-id") === studentId);
            if (duplicate) {
...
},{"@xatom/core":"j9zXV","../state/registrationState":"4GHSz","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"4GHSz":[function(require,module,exports) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"03l9a":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
function updateCheckoutLineItems(apiData) {
    ...
    new (0, _core.WFComponent)("#subscription_line_items_list").setHTML(html);
    // Empty state / wrapper visibility
    const itemsWrapper = new (0, _core.WFComponent)("#subscription_line_items_wrap");
    const emptyState = new (0, _core.WFComponent)("#subscription_line_items_empty");
...
},{"@xatom/core":"j9zXV","../state/registrationState":"4GHSz","./updateTotalAmount":"9u265","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"9u265":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@xatom/core":"j9zXV","../state/registrationState":"4GHSz","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"1aSWa":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@xatom/core":"j9zXV","../state/registrationState":"4GHSz","../../../utils/formUtils":"hvg7i","../../../utils/validationUtils":"dMBjH","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"hvg7i":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"6u422":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@xatom/core":"j9zXV","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"b2gDq":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
/**
...
async function submitCheckout() {
    ...
    // Send to API
    try {
        const response = await (0, _apiConfig.apiClient).post("/registration/checkout_labs", {
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "initializeDeleteOrderFromUrl", ()=>initializeDeleteOrderFromUrl);
var _apiConfig = require("../../../api/apiConfig");
const getUrlParams = ()=>{
...
const initializeDeleteOrderFromUrl = async ()=>{
    const { sessionId } = getUrlParams();
    if (!sessionId) return;
    try {
        const req = (0, _apiConfig.apiClient).delete(`/registration/cancel_order/${encodeURIComponent(sessionId)}`);
...
//# sourceMappingURL=registration_labs.0a975232.js.map
